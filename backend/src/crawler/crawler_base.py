...
class NewsCrawlerBase(metaclass=abc.ABCMeta):
    news_website_url: Union[AnyHttpUrl, str]
    news_website_news_child_urls: list[Union[AnyHttpUrl, str]]
    @abc.abstractmethod
    def get_headline(
    ...
    def validate_and_parse(self, url: Union[Session, None]) -> News:
        """
    ...
    @staticmethod
    @abc.abstractmethod
    def save(news: News, db: Union[Session, None]):
        """
    ...
    def _is_valid_url(self, url: Union[AnyHttpUrl, str]) -> bool:
        """
